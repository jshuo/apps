...
export const testChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    info: 'agence',
    providers: {
      'Aetheras': 'wss://ws.takecopter.cloud.agence.network'
    },
    text: 'Agence Takecopter',
    ui: {
      color: '#0000cc',
      logo: nodesAgenceSVG
    }
